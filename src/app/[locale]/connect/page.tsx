                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="lg:col-span-7 bg-muted/30 rounded-[1.5rem] p-6 md:p-12">
                            <form onSubmit={(e) => {
                                ...
                                window.location.href = `mailto:hello@gridsagency.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
                            }} className="space-y-8">
                                ...
                                <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-4">
                                    ...
                                    <button type="submit" className="bg-primary text-primary-foreground px-8 py-3 rounded-full text-sm font-medium hover:bg-tertiary hover:text-white transition-all duration-300 w-full md:w-auto shadow-lg shadow-tertiary/20 cursor-pointer">
                                        Send your Message
                                    </button>
                                </div>
                            </form>
